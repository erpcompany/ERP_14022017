            ...
            try
            {
                ...
                if (Request.Files["file"].ContentLength > 0)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        HH.MODEL_DAC_BIET= Convert.ToBoolean(ds.Tables[0].Rows[i][6].ToString());
                        HH.HINH_ANH = ds.Tables[0].Rows[i][7].ToString();
                        HH.DAC_TINH = ds.Tables[0].Rows[i][8].ToString();
                        HH.GHI_CHU = ds.Tables[0].Rows[i][9].ToString();
                        HH.TK_HACH_TOAN_KHO = Convert.ToInt32(ds.Tables[0].Rows[i][10].ToString());
                        HH.TK_DOANH_THU = Convert.ToInt32(ds.Tables[0].Rows[i][11].ToString());
                        HH.TK_CHI_PHI = Convert.ToInt32(ds.Tables[0].Rows[i][12].ToString());
