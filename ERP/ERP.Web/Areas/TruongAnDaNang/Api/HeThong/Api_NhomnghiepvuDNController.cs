...
namespace ERP.Web.Areas.TruongAnDaNang.Api.HeThong
{
    public class Api_NhomnghiepvuDNController : ApiController
    {
        ...
        // DELETE: api/Api_NhomnghiepvuDN/5
        [ResponseType(typeof(CN_NHOM_NGHIEP_VU))]
