...
namespace ERP.Web.Areas.TruongAnHaNoi.Api.HeThong
{
    public class Api_NhomnghiepvuTAHNController : ApiController
    {
        ...
        // PUT: api/Api_NhomnghiepvuTAHN/5
        ...
        // DELETE: api/Api_NhomnghiepvuTAHN/5
        [ResponseType(typeof(CN_NHOM_NGHIEP_VU))]
